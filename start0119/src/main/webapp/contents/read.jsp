...
<jsp:include page="/menu/top.jsp" flush='false' />
				        ...
				        <div class="col-sm-6">
				            ...
				            <div>
				              <div class="row" style="margin-bottom: 5px;">
				                ...
				                <div class="col-sm-9">
				                  <h3 style="margin: 0px;">
				                    <fmt:formatNumber  value="${contentsVO.stockPrice}" pattern="#,###.##" />원
				                  </h3>
				              ...
				              <div class="row" style="margin-bottom: 5px;">
				                ...
				                <div class="col-sm-9">
				                  ...
				                  <fmt:formatNumber var="expiry" value="${contentsVO.stockPrice * 0.01}" maxFractionDigits="1" />
				                  적립포인트&nbsp${expiry}원
				                  </span>
				                </div>
				              </div>
				            ...
				            <div> 
				              ...
				              <div style="margin-top: 10px;">
				                <div style="text-align: right;">
				                  총 상품금액 &nbsp 
				                  <span id="price">
				                   <fmt:formatNumber  value="${contentsVO.stockPrice}" pattern="#,###.##" /></span>원
				                </div>
				                <div style="text-align: right;">
				                  총 합계금액 &nbsp 
				                  <c:if test="${contentsVO.stockPrice < 25000}">
				                  	...
				                  	<span id="total_price"><fmt:formatNumber  value="${stockPrice +  deliveryCharge}" pattern="#,###.##" /></span>원
				                  </c:if>
				                  <c:if test="${contentsVO.stockPrice > 25000}">
				                  	<span id="total_price"><fmt:formatNumber  value="${contentsVO.stockPrice}" pattern="#,###.##" /></span>원
				                  </c:if>
				              ...
				              <div class="row" style="margin-top: 20px;">
				                <div class="col-sm-4">
				                  <button type="button" class="btn btn-primary" style="width: 100%; height: 50px;" id="purchase">바로구매</button>
				                </div>
				                <div class="col-sm-4">
	        ...
	        <nav class="navbar navbar-expand-md bg-dark" style="width: 100%;">
	          <div class="collapse navbar-collapse" id="myNavbar">
	            <ul class="nav navbar-nav" style="width: 100%;  text-align: center;">
	              <li style="width: 20%;"><a href="#section1" style="color: white;">상품상제정보</a></li>
	        ...
	        <nav class="navbar navbar-expand-md bg-dark">
	          <div class="collapse navbar-collapse" id="myNavbar">
	             <ul class="nav navbar-nav" style="width: 100%;  text-align: center;">
	              ...
	              <li style="width: 20%;"><a href="#section2" style="color: white;">배송안내</a></li>
	              <li style="width: 20%;"><a href="#section3">교환 및 반품 안내</a></li>
	              <li style="width: 20%;"><a href="#section4">상품 후기</a></li>
	              <li style="width: 20%;"><a href="#section5">상품 문의</a></li>
	            </ul>
	      ...
	      <div id="section3" style="margin: 10px 0 10px 0; width: 100%;">
	          ...
	          <div class="collapse navbar-collapse" id="myNavbar">
	           <ul class="nav navbar-nav" style="width: 100%;  text-align: center;">
	              <li style="width: 20%;" ><a href="#section1">상품상제정보</a></li>
	              <li style="width: 20%;"><a href="#section2">배송안내</a></li>
	              <li style="width: 20%;"><a href="#section3" style="color: white;">교환 및 반품 안내</a></li>
	              <li style="width: 20%;"><a href="#section4">상품 후기</a></li>
	              <li style="width: 20%;"><a href="#section5">상품 문의</a></li>
	            </ul>
	          </div>
	      ...
	      <div id="section4"  style="margin: 10px 0 10px 0; width: 100%;">
	        <nav class="navbar navbar-expand-md bg-dark" style="width: 100%;">
	            <div class="collapse navbar-collapse" id="myNavbar">
	                ...
	                <li style="width: 20%;"><a href="#section2">배송안내</a></li>
	                <li style="width: 20%;"><a href="#section3" >교환 및 반품 안내</a></li>
	                <li style="width: 20%;"><a href="#section4" style="color: white;">상품 후기</a></li>
	                <li style="width: 20%;"><a href="#section5">상품 문의</a></li>
	              </ul>
	            </div>
	        </nav>
	      ...
	      <div id="section5"  style="margin: 10px 0 10px 0; width: 100%;">
	        <nav class="navbar navbar-expand-md bg-dark" style="width: 100%;">
	            <div class="collapse navbar-collapse" id="myNavbar">
	                ...
	                <li style="width: 20%;"><a href="#section3" >교환 및 반품 안내</a></li>
	                <li style="width: 20%;"><a href="#section4" >상품 후기</a></li>
	                <li style="width: 20%;"><a href="#section5" style="color: white;">상품 문의</a></li>
	              </ul>
	            </div>
	        </nav>
	      </div>
	      ...
	      <!-- 상품 번호-->
	      <input type="hidden" value="${contentsVO.stockNo }" id="productno">
	      <!-- 상품 이름-->
